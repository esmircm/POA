<div class="form">
<h1><?php echo ucwords(CrugeTranslator::t("Gestión de sesiones"));?></h1>
...
<?php 
    ...
    $this->widget('booster.widgets.TbTabs', array(
        'type' => 'tabs',
        'tabs' => array(
            array('label' => 'Sesiones', 'url' => 'sessionadmin','active' => TRUE),
            array('label' => 'Variables del Sistema', 'url' => 'systemupdate'),
                  ))
    );?>
<?php 
