...
<div class="row">
    ...
    <div class='col-md-8'> 
        ...
        <?php echo $form->textFieldGroup($pedido, 'fk_descripcion', array('widgetOptions' => array('htmlOptions' => array('class' => 'span5')))); ?>
    ...
    <div class='col-md-2'> 
        ...
        <?php echo $form->textFieldGroup($pedido, 'unid_medida', array('widgetOptions' => array('htmlOptions' => array('class' => 'span5')))); ?>
    ...
    <div class='col-md-2'> 
        ...
        <?php echo $form->textFieldGroup($pedido, 'cantidad', array('widgetOptions' => array('htmlOptions' => array('class' => 'span5')))); ?> 
