           ...
           <table id='AccionesPOA' class="table table-bordered" style="text-align:center;">
            ...
            foreach ($lista_accion as $data){
                ...
                $html .= '<td style="text-align: center"><span style="font-size: 40px; color: #2282cd; cursor: pointer;" class="glyphicon glyphicon-trash" onclick="eliminar_accion(this,' . $data->id_accion . ')" /></span>'
                        . '<span style="font-size: 40px; color: #2282cd; cursor: pointer;" class="glyphicon glyphicon-pencil" onclick="editar_accion(this,' . $data->fk_proyecto . ',' . $data->id_accion . ')" /></span></td>';
                $html .= '</tr>';
                echo $html;
            }
            ?>
