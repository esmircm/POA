...
<p class="help-block">Los campos con <span class="required">*</span> son obligatorios.</p>
        ...
        <?php // echo $form->hiddenField($consultaPersona, 'id_personal_supervisado'); ?>
<div class="row">
   ...
   <div class='col-md-2'>
        <?php
        echo $form->textFieldGroup($consultaPersona, 'cedula_evaluado', array('widgetOptions' => array('htmlOptions' => array('class' => 'span2', 'readOnly' => true)))); ?>
    </div> 
