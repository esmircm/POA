...
<div class="row">
    <div class="span-20">
        ...
        $this->widget(
            ...
            'content' => $this->renderPartial('_periodo_dir', array('form' => $form, 'consultaPersona' => $consultaPersona), TRUE),
                )
        );
        ?>
    </div>
    <div class="span-20">
        ...
        $this->widget(
            ...
            'headerIcon' => 'user',
            'headerHtmlOptions' => array('style' => 'background-color: #B2D4F1 !important;color: #000000 !important;'),
            'content' => $this->renderPartial('_odi_supervisor_dir', array('form' => $form, 'consultaPersona' => $consultaPersona), TRUE),
                )
        );
        ...
        $this->widget(
            ...
            'headerIcon' => 'user',
            'headerHtmlOptions' => array('style' => 'background-color: #B2D4F1 !important;color: #000000 !important;'),
            'content' => $this->renderPartial('_odi_supervisado_dir', array('form' => $form,'consultaPersona' => $consultaPersona), TRUE),
                )
        );
        ?>
    </div>
...
//        );
    ...
    <div class="span-20">
        ...
        $this->widget(
            ...
            'headerHtmlOptions' => array('style' => 'background-color: #B2D4F1 !important;color: #000000 !important;'),
            'content' => $this->renderPartial('_objetivos_odi_nuevo_dir', array('form' => $form,'consultaPersona' => $consultaPersona,'model'=> $model,'id_evaluacion'=> $id_evaluacion), TRUE),
                )
        );
        ?>
    </div> 
    ...
    $this->widget(
        ...
        'headerIcon' => 'list',
        'headerHtmlOptions' => array('style' => 'background-color: #B2D4F1 !important;color: #000000 !important;'),
        'content' => $this->renderPartial('_comentario_dir', array('form' => $form, 'Comentarios' => $Comentarios, 'consultaPersona' => $consultaPersona, 'EstatusEvaluacion' => $EstatusEvaluacion), TRUE),
            )
    );
    ?>
</div>
...
//                'label' => 'Guardar',
//                'htmlOptions' => array(
//                    'onclick' => 'document.location.href ="' . $this->createUrl('/evaluacion/dir') . '"',
//                )
//            ));
            ?>
        </div>
