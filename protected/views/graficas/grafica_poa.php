            ...
            if(isset($_POST['MaestroPoa'])){
                ...
                <?php
                    $this->widget('booster.widgets.TbButton', array(
                        ...
                        'size' => 'large',
                        'context' => 'success',
                        'url' => Yii::app()->createUrl("graficas/GraficaAcciones", array("id_poa"=>$id_poa, "tipo"=>$tipo)),
...
<div style="width: 90%; text-align: center; margin: 0 auto; margin-bottom: 50px;">
    <?php
    
    echo $this->renderPartial('_tabla_rendimiento', array('html' => $html), TRUE);
