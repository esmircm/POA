...
<div style="width: 10%; display: inline-block; float: right">
    <div style="width: 100%; height: 100%; text-align: center;">
        <div onclick="GuardarAccion()" class="ValidationButton"><span id="button_save_accion" class="glyphicon glyphicon-play" style="margin-top: 25%; margin-bottom: 25%;"></span></div>
