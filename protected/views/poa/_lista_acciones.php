<div class="row">
    <div class='col-md-12'>
           <table id='AccionesPOA' class="table table-bordered animatedParent" data-sequence='500' style="text-align:center;">
    ...
    <!--</div>-->
            ...
            foreach ($lista_accion as $data){
                ...
                $html .= '<td style="text-align: center">'
                        ...
                        . '<span style="font-size: 40px; color: #2282cd; cursor: pointer;" class="glyphicon glyphicon-trash" data-toggle="tooltip" title="" rows="1" data-original-title="Eliminar Acción" onclick="eliminar_accion(this,' . $data->id_accion . ')" /></span>';
