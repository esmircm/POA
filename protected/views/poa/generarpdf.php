...
$html.='<tr>
            <td width="20%" style=" height: 1%; text-align:left; background-color: rgba(167,10,10,1); color: #fff; border-collapse: collapse;"><strong><font style= "font-size:9px;">1.NOMBRE DEL PROYECTO</font></strong></td>
...
$html.='<tr>
            ...
            <td rowspan="2" width="10%" style="background-color: rgba(167,10,10,1); color: #fff; height: 3%; border-right: 1px solid;"><font style= "font-weight: bold; font-size:9px;">LOCALIZACIÓN (ENTIDAD)</font></td>
     ...
     foreach ($vswaccion as $data){
       $html.= '<tr>
            ...
            <td style= "height: 2%; border-bottom: 1px solid; border-right: 1px solid;"><font style= "height: 2%; text-transform: uppercase; font-size:9px;">'.$data->cantidad.'</font></td>
            <td style= "height: 2%; border-bottom: 1px solid; border-right: 1px solid;"><font style= "height: 2%; font-size:9px;">'.$data->ambito.'</font></td>
...
$htmlP2.="<div style='text-align:center; font-size:13px;  margin-top:50px; border: solid 0px #000;'>";
$htmlP2.='<br><br><br><br><b>Plan Operativo Anual '.date('Y').'</b>';
$htmlP2.='<br><font style=" text-align:center; font-size:11px;">Formulación del Plan</font><br><br>'; 


$htmlP2.='<div><table width="100%"  cellspacing=0 cellpadding=0 style="text-align:center; margin: 0 auto;">';
$htmlP2.='<tr>
            <td width="20%" style=" height: 1%; text-align:left; background-color: rgba(167,10,10,1); color: #fff; border-collapse: collapse;"><strong><font style= "font-size:9px;">1.NOMBRE DEL PROYECTO</font></strong></td>
            <td style=" height: 2%; border-top: 1px solid; border-right: 1px solid;"><font style= "text-transform: uppercase; font-size:10px;">'.$vswpdfproyecto->nombre_proyecto.'</font></td>
        </tr>
...
$htmlP2.='<div><table width="100%" cellspacing=0 cellpadding=0 style="text-align:center; margin: 0 auto; border: 1px solid; ">';

$htmlP2.='<tr>
            <td rowspan="2" width="15%" style=" background-color: rgba(167,10,10,1); color: #fff; height: 4%; border-right: 1px solid;"><font style= "font-weight: bold; font-size:9px;">ACTIVIDADES</font></td>
            <td rowspan="2" width="10%" style="  background-color: rgba(167,10,10,1); color: #fff; height: 4%; border-right: 1px solid;"><font style= "font-weight: bold; font-size:9px;">BIEN O SERVICIO</font></td>
            <td colspan="2" width="5%" style="background-color: rgba(167,10,10,1); color: #fff; height: 3%; border-right: 1px solid;"><font style= "font-weight: bold; font-size:9px;">META TOTAL</font></td>

            <td rowspan="2" width="5%" style="  background-color: rgba(167,10,10,1); color: #fff; height: 4%; border-right: 1px solid;"><font style= "font-weight: bold; font-size:9px;">LOCALIZACIÓN (ENTIDAD)</font></td>
                
                <td colspan="13" width="65%" valign="middle" style="background-color: rgba(167,10,10,1); color: #fff; text-align: center; height: 2%; border-right: 1px solid; border-bottom: 1px solid; vertical-align=middle;"><font style= "font-weight: bold; font-size:9px;">PROGRAMACIÓN FÍSICA MENSUAL AÑO '.date('Y').'</font>
                <tr>
                
                   <td width="5%" style= "height: 1%; border-right: 1px solid; background-color: rgba(186,178,178,1);"><font style= "font-size:8px;">UNIDAD DE MEDIDA</font></td>
                   <td width="5%" style= "height: 1%; border-right: 1px solid; background-color: rgba(186,178,178,1);"><font style= "font-size:8px;">CANTIDAD</font></td>    
    ...
    foreach ($vswaccion as $data){
      $htmlP2.= '<tr border=1px>
            <td width="17%" style="height: 2%; border-bottom: 1px solid; border-right: 1px solid;"><font style= "font-size:9px;">'.$data->nombre_accion.'</font></td>
            <td width="3%" style="height: 2%; border-bottom: 1px solid; border-right: 1px solid;"><font style= "font-size:9px;">'.$data->bien_servicio.'</font></td>
            <td width="5%" style="height: 2%; border-bottom: 1px solid; border-right: 1px solid;"><font style= "font-size:9px;">'.$data->unidad_medida.'</font></td>
                     
                   <td width="5%" style= "height: 2%; border-right: 1px solid; border-bottom: 1px solid;"><font style= "font-size:9px;">'.$data->cantidad.'</font></td>
                   <td width="5%" style= "height: 2%; border-right: 1px solid; border-bottom: 1px solid;"><font style= "font-size:9px;">'.$data->ambito.'</font></td>';
      foreach ($maestro as $meses){
                   $htmlP2.= '<td width="5%" style= "height: 2%; border-right: 1px solid; border-bottom: 1px solid;"><font style= "font-size:9px;">'. Acciones::model()->suma_programado($data->id_accion, ' AND fk_meses in('. $meses->id_maestro .') ') .'</font></td>';
      }
                   $htmlP2.= '<td width="5%" style= "height: 2%; border-right: 1px solid; border-bottom: 1px solid;"><font style= "font-size:9px;">'.$data->cantidad.'</font></td>';
...
$htmlP2.='<br><br>';
$htmlP2.='<div>';
$htmlP2.='<div style= "width:50%; display:inline-block; float: left;"><table width="80%"  cellspacing=0 cellpadding=0 style="margin-right: auto;">';
$htmlP2.='<tr>
            <td colspan="2" style=" height: 2%; text-align:center; background-color: rgba(186,178,178,1); border-collapse: collapse;"><font style= "text-align: center; font-weight: normal; font-size:9px;">FUNCIONARIO RESPONSABLE DE EMITIR LA INFORMACIÓN</font></td>
        </tr>
...
$htmlP2.='<div style= "width:50%; display:inline-block; text-align: right;"><table width="80%"  cellspacing=0 cellpadding=0 style="margin-left: auto;">';
$htmlP2.='<tr>
            <td colspan="2" style="height: 2%; text-align:center; background-color: rgba(186,178,178,1); border-collapse: collapse;"><font style= "font-weight: normal; font-size:9px; text-align: center; ">RESPONSABLES POR LA OFICINA  DE PLANIFICACIÓN Y PRESUPUESTO</font></td>
        </tr>
        <tr>
...
$htmlP3[$dato->id_accion].="<div style='text-align:center; font-size:13px;  margin-top:50px; border: solid 0px #000;'>";
$htmlP3[$dato->id_accion].='<br><br><br><br><b>Plan Operativo Anual '.date('Y').'</b>';
$htmlP3[$dato->id_accion].='<br><font style=" text-align:center; font-size:11px;">Formulación del Plan</font><br><br>'; 


$htmlP3[$dato->id_accion].='<div><table width="100%"  cellspacing=0 cellpadding=0 style="text-align:center; margin: 0 auto;">';
$htmlP3[$dato->id_accion].='<tr>
...
$htmlP3[$dato->id_accion].='<br>';
        
$htmlP3[$dato->id_accion].='<div><table width="100%" cellspacing=0 cellpadding=0 style="text-align:center; margin: 0 auto; border: 1px solid; ">';
...
$htmlP3[$dato->id_accion].='<tr>
    ...
    foreach ($vswactividades as $data){
      $htmlP3[$dato->id_accion].= '<tr border=1px>
    ...
    foreach ($maestro as $meses){
        $htmlP3[$dato->id_accion].= '<td width="5%" style= "height: 2%; border-right: 1px solid; border-bottom: 1px solid;"><font style= "font-size:9px;">'. Actividades::model()->suma_programado($data->id_actividades, ' AND fk_meses in('. $meses->id_maestro .') ') .'</font></td>';
      }   
                   
                  $htmlP3[$dato->id_accion].= '<td width="5%" style= "height: 2%; border-right: 1px solid; border-bottom: 1px solid;"><font style= "font-size:9px;">'.$data->cantidad.'</font></td>
            
        </tr>';
        }
$htmlP3[$dato->id_accion].='</table>
</div>';


$htmlP3[$dato->id_accion].='<br><br>';
$htmlP3[$dato->id_accion].='<div>';
$htmlP3[$dato->id_accion].='<div style= "width:50%; display:inline-block; float: left;"><table width="80%"  cellspacing=0 cellpadding=0 style="margin-right: auto;">';
$htmlP3[$dato->id_accion].='<tr>
            <td colspan="2" style=" height: 2%; text-align:center; background-color: rgba(186,178,178,1); border-collapse: collapse;"><font style= "text-align: center; font-weight: normal; font-size:9px;">FUNCIONARIO RESPONSABLE DE EMITIR LA INFORMACIÓN</font></td>
        </tr>
...
$htmlP3[$dato->id_accion].='<div style= "width:50%; display:inline-block; text-align: right;"><table width="80%"  cellspacing=0 cellpadding=0 style="margin-left: auto;">';
$htmlP3[$dato->id_accion].='<tr>
            <td colspan="2" style="height: 2%; text-align:center; background-color: rgba(186,178,178,1); border-collapse: collapse;"><font style= "font-weight: normal; font-size:9px; text-align: center; ">RESPONSABLES POR LA OFICINA  DE PLANIFICACIÓN Y PRESUPUESTO</font></td>
        </tr>
        <tr>
