...
//            if(isset($lista_actividad)){
                foreach ($lista_actividad as $data){
                    ...
                    $html .= '<td style="text-align: center">'
                            . '<span style="font-size: 40px; color: #2282cd; cursor: pointer;" class="glyphicon glyphicon-pencil" onclick="editar_actividad(this,' . $data->id_actividades . ')" /></span>'
                            . '<span style="font-size: 40px; color: #2282cd; cursor: pointer;" class="glyphicon glyphicon-trash" onclick="eliminar_actividad(this,' . $data->id_actividades . ')" /></span></td>';
                    $html .= '</tr>';
                    echo $html;
                }
//            }
