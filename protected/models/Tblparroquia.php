...
class Tblparroquia extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('strlimite_norte, strlimite_sur, strlimite_este, strlimite_oeste, strobservaciones, blnprefijo, blncapital, blnurbana, blnborrado, dtmregistro, dtmmodificado, geometrico', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('clvcodigo, clvmunicipio, strid, clvparroquia_sunacoop, strdescripcion, intsuperficie, strlatitud, strlongitud, strlimite_norte, strlimite_sur, strlimite_este, strlimite_oeste, strobservaciones, blnprefijo, blncapital, blnurbana, blnborrado, dtmregistro, dtmmodificado, clvusuario, geometrico', 'safe', 'on'=>'search'),
		);
	}
