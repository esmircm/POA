...
/**
 * This is the model class for table "evaluacion.vsw_admin".
 *
 * The followings are the available columns in table 'evaluacion.vsw_admin':
 ...
 * @property integer $cod_dependencia_evaluador_gruge
 * @property string $dep_evaluador_cruge
 */
class VswAdmin extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_persona_evaluado, cedula, cod_dependencia_evaluado, id_evaluacion, id_persona, cod_dependencia_evaluador, fk_estatus_evaluacion, cod_dependencia_evaluador_gruge', 'numerical', 'integerOnly'=>true),
	...
	public function attributeLabels()
	{
		return array(
			...
			'cod_dependencia_evaluador_gruge' => 'Cod Dependencia Evaluador Gruge',
			'dep_evaluador_cruge' => 'Dep Evaluador Cruge',
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('cod_dependencia_evaluador_gruge',$this->cod_dependencia_evaluador_gruge);
		$criteria->compare('dep_evaluador_cruge',$this->dep_evaluador_cruge,true);
...
//		$criteria->compare('fecha_creacion_evaluacion',$this->fecha_creacion_evaluacion,true);
		$criteria->compare('id_persona', $id_persona);
                $criteria->compare('cod_dependencia_evaluador',$this->cod_dependencia_evaluador);
//		$criteria->compare('cod_dependencia_evaluador', $dependencia);
                $criteria->compare('dep_evaluador',$this->dep_evaluador);
		$criteria->compare('fk_estatus_evaluacion',$this->fk_estatus_evaluacion);
                $criteria->compare('estatus',$this->estatus,true);
		$criteria->compare('tiene_objetivos',$this->tiene_objetivos,true);
                $criteria->compare('cod_dependencia_evaluador_gruge',$dependencia);
		$criteria->compare('dep_evaluador_cruge',$this->dep_evaluador_cruge,true);
