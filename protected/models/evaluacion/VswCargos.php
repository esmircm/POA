...
class VswCargos extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_persona, cedula, fk_cargo, fk_coordinacion, fk_direccion, fk_dir_linea, fk_despacho, fk_tipo_entidad', 'numerical', 'integerOnly'=>true),
			...
			array('id_persona, nacionalidad, cedula, apellidos, nombres, sexo, fk_cargo, cargo, fk_coordinacion, coordinacion, fk_direccion, direccion, fk_dir_linea, direccion_linea, fk_despacho, despacho, fk_tipo_entidad', 'safe', 'on'=>'search'),
		);
	}
