...
class VswListarPersonas extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('id_persona_evaluado, cedula_evaluado, cod_nomina_evaluado, fk_cargo_evaluado, id_persona, id_evaluacion, fk_periodo, cedula, codigo_nomina, fk_cargo, fk_estatus_evaluacion, id_comentario', 'numerical', 'integerOnly'=>true),
			array('nacionalidad_evaluado, sexo_evaluado, nacionalidad, sexo', 'length', 'max'=>1),
			array('cargo_evaluado', 'length', 'max'=>60),
			...
			array('apellidos_evaluado, nombres_evaluado, fk_tipo_clase, periodo_evaluacion, apellidos, nombres, estatus, tiene_objetivos, cant_objetivos, peso_total', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_persona_evaluado, apellidos_evaluado, nombres_evaluado, nacionalidad_evaluado, cedula_evaluado, sexo_evaluado, cod_nomina_evaluado, fk_cargo_evaluado, cargo_evaluado, fk_tipo_clase, oficina_evaluado, telefono_evaluado, id_persona, id_evaluacion, fk_periodo, periodo_evaluacion, apellidos, nombres, nacionalidad, cedula, sexo, codigo_nomina, fk_cargo, dependencia, telef_oficina, obj_funcional, fk_estatus_evaluacion, estatus, id_comentario, comentario, tiene_objetivos, cant_objetivos, peso_total', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		return new CActiveDataProvider($this, array(
        	...
        	public function searchlistar($estatus_evaluacion)
	{
		// @todo Please modify the following code to remove attributes that should not be searched.
